...
| aria-labelledby-missing | flagged | aria-valid-attr-value, link-name | link-name, aria-valid-attr-value | yes | yes | no | Detected inside page-level content. |
...
| carousel-structure | guided-only | role-img-alt | role-img-alt | yes | yes | no | Detected inside page-level content. |
...
| audio-controls | guided-only | aria-allowed-role, color-contrast | aria-allowed-role, color-contrast | yes | yes | no | Detected inside page-level content. |
...
| testimonials-quote | guided-only | color-contrast | color-contrast | yes | yes | no | Detected inside page-level content. |
